...
import { TableOfContents } from "@/features/blogs/ui/components/table-of-contents";
import { MobileTableOfContents } from "@/features/blogs/ui/components/mobile-toc";
import { AuthorCard } from "@/features/blogs/ui/components/author-card";
import { ReadMoreSection } from "@/features/blogs/ui/components/read-more-section";
import { PromoContent } from "@/features/blogs/ui/components/promo-content";
...
export default function BlogPostClient({ blog, slug }: BlogPostClientProps) {
  return (
    <motion.div
      ...
      <div className="flex flex-col pt-30 pb-12 px-6 border-b border-gray-100">
        <div className="max-w-7xl mx-auto w-full flex flex-col gap-6">
          ...
          >
            ...
            <time>{formatDate(blog.publishedAt as string || "")}</time>
          </motion.div>
              ...
              {blog.author && (
                <AuthorCard
                  author={{
                    ...
                    position: blog.author.position || "Author",
